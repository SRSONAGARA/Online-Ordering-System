 ...
 /* void accessApi(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => authGetxController.isLoading.value? Center(child: CircularProgressIndicator(color: const Color.fromRGBO(86, 126, 239, 15))): SingleChildScrollView(
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value!.isEmpty) {
                          ...
                          return "Mobile No is not less than 10 letter".tr;
                        } else {
                          return null;
                        }
                      },
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (authGetxController.signupModelClassGetx.status == 1) {
                                ...
                                showDialog(context: context, builder: (_){
                                  return AlertDialog(
                                    title: Text('Already registered'.tr),
                                    content: Text('User Already Exist with same Email-Id try with different Email-Id!'.tr),
                                    actions: <Widget>[
                                      TextButton(
                                        onPressed: () {
                                          Get.back();
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            ...
                            child: Text('Login'.tr, style: TextStyle(color: Color
                                .fromRGBO(
                                86,
                                126,
                                239,
