...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: authRepoProvider.isLoading
                              ...
                              if (formkey.currentState!
                                ...
                                if (authRepoProvider.loginData[0].status == 1) {
                                  ...
                                  await prefs.setString(
                                      'jwtToken',
                                      authRepoProvider
                                          .loginData[0].data.jwtToken);
                                  print('jwttoken: ${prefs.get('jwtToken')}');
                                  await prefs.setString('name',
                                      authRepoProvider.loginData[0].data.name);
                                  await prefs.setString(
                                      'emailId',
                                      authRepoProvider
                                          .loginData[0].data.emailId);
                                  await prefs.setString(
                                      'mobileNo',
                                      authRepoProvider
                                          .loginData[0].data.mobileNo);
