...
import 'package:oline_ordering_system/Bloc/ViewsBloc/auth_pages/login_screen/cubit/login_screen_state.dart';

import '../../../../GetX/viewsGetx/app_pagesGetx/homeScreenGetx.dart';
import '../forgot_psw_screen.dart';
      ...
      body: BlocConsumer<LoginScreenCubit, LoginScreenState>(
        ...
        if (state is LoginScreenSuccessState) {
          ...
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (_) => const HomeScreenGetx()),
              (route) => false);
        }
      }),
    );
